...
class ProcessingData:
    encoder_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../data/res/encoder.pkl')
    tfidf_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../data/res/tfidf.pkl')
    data: pd.DataFrame

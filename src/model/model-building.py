...
def model_training(X_train, y_train) -> None:
    try:
        ...
        save_object(knn_model, os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../data/res/clf.pkl'))
    except Exception as e:
        print(e)
        raise

if __name__=="__main__":
    train_data = load_data(data_url=os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../data/processed/train.csv'))
